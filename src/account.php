      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-xl-7 ftco-animate">
            <form action="account.php" class="billing-form" method="POST">
              ...
              <div class="row align-items-end">
                ...
                <p>
                  ...
                  <input type="submit" value="Create an acount" class="btn btn-primary py-3 px-4">
                </p>
              </div>
            </form>
            <!-- END -->
